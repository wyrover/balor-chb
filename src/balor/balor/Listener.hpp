...
/**
 * Event を引数に取る返値の無い関数や関数オブジェクトをｴ・ﾔ、追加できる関数オブジェクト。
 *
 ...
 * ラ??式をｴ・ﾔする場合は?イン?一個分までのキャプ?ャならばメモリ割り当ては発生しない。
 * 
...
#pragma warning(disable : 4522) // '::balor::Listener<Sender, Event>' : 複数のｴ・ﾔ演算子が指定されています。
